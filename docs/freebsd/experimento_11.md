...
<p class="question">1. Em certo momento do experimento, bastou apenas executar o comando <b>ifconfig &lt;interface&gt; inet6 -ifdisabled</b> para que um IPv6 fosse configurado. Por que ocorreu isso e como desativar essa configuração automática?</p>
<div>
