...
### Configurar os clientes na rede de testes e validar as configurações.
Lembrem-se das etapas que foram percorridas na **Prática de Laboratório 01**.

### Interações com o serviço de resolução de nomes (DNS)
...
### Interações com o serviço HTTP
Usando os conceitos que foram estudados sobre o protocol HTTP, use a ferramenta **telnet** para obter um objeto de determinado site HTTP.
```console
